...
// The remaining constants are exported to allow for fixed-length array instantiation. For a given security level, the constants are the same as the output of the k.SIZEX() functions defined in keys.go
const (
	n            = 256
	q            = 3329
	qInv         = 62209
